...
Feature: Create Content Types
  ...
  @WEOS-1398
  Scenario: User update field that automatically updated

    If a field is marked to be updated automatically based on an operation then a user should not be able to update that
    field by passing in a value in the payload.
    ...
    And "Sojourner" is on the "Blog" create screen
    And "Sojourner" enters "3" in the "id" field
    And "Sojourner" enters "2021-03-09T17:55:25Z" in the "created" field
    And "Sojourner" enters "Some Blog" in the "title" field
    And "Sojourner" enters "Some Description" in the "description" field
    When the "Blog" is submitted
    Then the "Blog" is created
