Feature: View content
  ...
  Scenario: Get blog details
    ...
    And the "ETag" header hould be "22xu1Xa5CS3DK1Om2tB7OBDfWAF.2"
  ...
  Scenario: Get blog details using the entity id
    ...
    And the "ETag" header hould be "22xu4iw0bWMwxqbrUvjqEqu5dof.1"
  ...
  Scenario: Get specific version of an entity
    ...
    And the "ETag" header hould be "22xu4iw0bWMwxqbrUvjqEqu5dof.2"
