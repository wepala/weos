...
var policedVocabularies = map[string]map[string]bool{
	...
	"https://schema.org/": namesToSet(
		...
		"image", "inLanguage", "isBasedOn", "isPartOf", "itemListElement", "keywords", "location", "logo",
		"mainEntity", "maximumAttendeeCapacity", "name", "nutrition", "position", "prepTime", "price",
		...
		"scheduleTimezone", "seller", "servesCuisine", "serviceType", "servingSize", "sku", "sodiumContent",
		"startDate", "startTime", "sugarContent", "suitableForDiet", "telephone", "text", "thumbnailUrl", "totalTime",
		"url", "version",
	),
