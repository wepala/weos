...
<template>
  <a-form :model="form" layout="vertical" @finish="handleSubmit">
    ...
    <a-form-item v-if="isEdit" label="Version" name="version">
      <a-input v-model:value="form.version" />
    </a-form-item>
    <a-form-item v-if="isEdit" label="Thumbnail URL" name="thumbnail_url">
      <a-input v-model:value="form.thumbnail_url" />
    </a-form-item>
